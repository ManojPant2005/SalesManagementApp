...
namespace SalesManagementApp.Services
{
    public class OrderService : IOrderService
    {
        ...
        public OrderService(SalesManageDbContext salesManagementDbContext,
        ...
        private async Task UpdateSalesOrderReportsTable(int orderId, Order order)
        {
            try
            {
                List<SalesOrderReport> srItems = await (from oi in this.salesManagementDbContext.OrdersItem
