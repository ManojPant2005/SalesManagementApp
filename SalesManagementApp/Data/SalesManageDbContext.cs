...
{
    public class SalesManageDbContext : IdentityDbContext<IdentityUser>
    {
        public SalesManageDbContext(DbContextOptions<SalesManageDbContext> options):base(options)
