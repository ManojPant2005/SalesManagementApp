...
namespace SalesManagementApp.Extensions
{
    public static class Conversions
    {
        ...
        public static async Task<List<OrgnisationModel>> ConvertToHierarchy(this IQueryable<Employee> employees, SalesManageDbContext context)
        {
            return await (from e in employees
                          join t in context.EmployeeJobTitles
                          on e.EmployeeJobTitleId equals t.EmployeeJobTitleId
                          orderby e.Id
                          select new OrgnisationModel
                          {
        ...
        public static async Task<Employee> GetEmployeeObject(this System.Security.Claims.ClaimsPrincipal user, SalesManageDbContext context)
        {
